<div x-data="{
    team: JSON.parse('{{ json_encode($project->team) }}'),
}" x-on:add-team-member.window="team.push($event.detail)" x-show='team.length' x-transition>
                ...
                <div x-bind:id="'user-' + user.id_hash"
                    ...
                    <div x-data="{
                        ...
                        remove: async function(slug, hash) {
                            ...
                            this.team.splice(x => x.id_hash === hash, 1);
                        },
                    }">
